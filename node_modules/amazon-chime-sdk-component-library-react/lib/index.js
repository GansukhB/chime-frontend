...
var badgeLayout = {
    sm: styled.css(templateObject_4$8 || (templateObject_4$8 = __makeTemplateObject(["\n    top: -15%;\n    left: 76%;\n  "], ["\n    top: -15%;\n    left: 76%;\n  "]))),
    md: styled.css(templateObject_5$5 || (templateObject_5$5 = __makeTemplateObject(["\n    top: 4%;\n    left: 76%;\n  "], ["\n    top: 4%;\n    left: 76%;\n  "]))),
    lg: styled.css(templateObject_6$2 || (templateObject_6$2 = __makeTemplateObject(["\n    top: 10%;\n    left: 76%;\n  "], ["\n    top: 10%;\n    left: 76%;\n  "]))),
};
...
var StyledArrow = styled__default['default'](Svg)(templateObject_1$B || (templateObject_1$B = __makeTemplateObject(["\n  transform: ", ";\n"], ["\n  transform: ",
    ";\n"])), function (_a) {
...
var StyledCaret = styled__default['default'](Svg)(templateObject_1$A || (templateObject_1$A = __makeTemplateObject(["\n  transform: ", ";\n"], ["\n  transform: ",
    ";\n"])), function (_a) {
    var direction = _a.direction;
...
// Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
var StyledCircle = styled__default['default'].circle(templateObject_1$y || (templateObject_1$y = __makeTemplateObject(["\n  fill: ", ";\n"], ["\n  fill: ", ";\n"])), function (props) { return props.theme.colors.primary.main; });
...
var StyledSvg = styled__default['default'](SvgWithoutMicrophoneProps)(templateObject_1$x || (templateObject_1$x = __makeTemplateObject(["\n  ", "\n"], ["\n  ",
    "\n"])), function (props) {
...
var LocalAudioOutputProvider = function (_a) {
    ...
    var value = React.useMemo(function () { return ({ isAudioOn: isAudioOn, toggleAudio: toggleAudio }); }, [isAudioOn, toggleAudio]);
...
var LocalVideoProvider = function (_a) {
    ...
    var value = React.useMemo(function () { return ({ tileId: tileId, isVideoEnabled: isVideoEnabled, setIsVideoEnabled: setIsVideoEnabled, toggleVideo: toggleVideo }); }, [tileId, isVideoEnabled, setIsVideoEnabled, toggleVideo]);
...
// Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
var MeetingEventProviderContext = React.createContext(undefined);
var MeetingEventProvider = function (_a) {
    var children = _a.children;
    var _b = React.useState(), meetingEvent = _b[0], setMeetingEvent = _b[1];
    var meetingManager = useMeetingManager();
    React.useEffect(function () {
...
var useMeetingEvent = function () {
    var meetingEvent = React.useContext(MeetingEventProviderContext);
    return meetingEvent;
};
...
var MeetingManager = /** @class */ (function () {
    function MeetingManager(meetingManagerConfig) {
        ...
        this.audioVideoDidStop = function (sessionStatus) {
            ...
            switch (sessionStatusCode) {
                case amazonChimeSdkJs.MeetingSessionStatusCode.AudioCallEnded:
                ...
                case amazonChimeSdkJs.MeetingSessionStatusCode.Left:
                    ...
                    _this.meetingStatus = exports.MeetingStatus.Left;
                    _this.publishMeetingStatus();
                    _this.leave();
                    break;
        ...
        this.selectAudioInputDevice = function (device) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 8:
                        innerDevice = null;
                        if (!amazonChimeSdkJs.isAudioTransformDevice(device)) return [3 /*break*/, 10];
                    ...
                    case 10:
                        ...
                        _c.label = 11;
                    case 11:
                        deviceId = amazonChimeSdkJs.DefaultDeviceController.getIntrinsicDeviceId(innerDevice);
        ...
        this.selectVideoInputDevice = function (device) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 8:
                        innerDevice = null;
                        if (!amazonChimeSdkJs.isVideoTransformDevice(device)) return [3 /*break*/, 10];
                        return [4 /*yield*/, device.intrinsicDevice()];
                    case 9:
                        innerDevice = _c.sent();
                        return [3 /*break*/, 11];
    ...
    MeetingManager.prototype.join = function (_a) {
        var meetingInfo = _a.meetingInfo, attendeeInfo = _a.attendeeInfo, _b = _a.deviceLabels, deviceLabels = _b === void 0 ? exports.DeviceLabels.AudioAndVideo : _b, eventReporter = _a.eventReporter, meetingManagerConfig = _a.meetingManagerConfig;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        this.meetingSession = new amazonChimeSdkJs.DefaultMeetingSession(configuration, logger, deviceController, this.eventReporter);
    ...
    MeetingManager.prototype.createLogger = function (configuration) {
        ...
        var consoleLogger = new amazonChimeSdkJs.ConsoleLogger('SDK', logLevel);
        ...
        if (postLogConfig) {
            ...
            logger = new amazonChimeSdkJs.MultiLogger(consoleLogger, new amazonChimeSdkJs.MeetingSessionPOSTLogger(name_1, configuration, batchSize, intervalMs, url, logLevel_1));
        }
        return logger;
    };
...
var MeetingProvider = function (_a) {
    var _b = _a.logLevel, logLevel = _b === void 0 ? amazonChimeSdkJs.LogLevel.WARN : _b, postLogConfig = _a.postLogConfig, _c = _a.simulcastEnabled, simulcastEnabled = _c === void 0 ? false : _c, _d = _a.enableWebAudio, enableWebAudio = _d === void 0 ? false : _d, logger = _a.logger, onDeviceReplacement = _a.onDeviceReplacement, videoDownlinkBandwidthPolicy = _a.videoDownlinkBandwidthPolicy, meetingManagerProp = _a.meetingManager, children = _a.children;
...
var DevicesProvider = function (_a) {
    var children = _a.children, onDeviceReplacement = _a.onDeviceReplacement;
    return (React__default['default'].createElement(AudioInputProvider, { onDeviceReplacement: onDeviceReplacement },
...
var useSelectAudioInputDevice = function () {
    var meetingManager = useMeetingManager();
    var selectDevice = React.useCallback(function (device) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
...
// Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
var BackgroundBlurProviderContext = React.createContext(undefined);
var BackgroundBlurProvider = function (_a) {
    var spec = _a.spec, options = _a.options, children = _a.children;
    var _b = React.useState(undefined), isBackgroundBlurSupported = _b[0], setIsBackgroundBlurSupported = _b[1];
    var _c = React.useState(), processor = _c[0], setProcessor = _c[1];
    React.useEffect(function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, amazonChimeSdkJs.BackgroundBlurVideoFrameProcessor.create(spec, options)];
                        case 1:
    ...
    var createBackgroundBlurDevice = function (selectedDevice) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            try {
                ...
                if (processor) {
                    chosenVideoTransformDevice = new amazonChimeSdkJs.DefaultVideoTransformDevice(logger, selectedDevice, [processor]);
...
var useBackgroundBlur = function () {
    var context = React.useContext(BackgroundBlurProviderContext);
    if (!context) {
...
var BackgroundBlurCheckbox = function (_a) {
    ...
    var _e = React.useState(meetingManager.selectedVideoInputTransformDevice), device = _e[0], setDevice = _e[1];
    // TODO: Move this to the Video Input Provider and expose only one selected Video Input device state
    React.useEffect(function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (!!amazonChimeSdkJs.isVideoTransformDevice(device)) return [3 /*break*/, 5];
                    setIsLoading(true);
    ...
    return (React__default['default'].createElement(FormField, { field: Checkbox, onChange: toggleBackgroundBlur, value: 'Background Blur', checked: amazonChimeSdkJs.isVideoTransformDevice(device), label: label }));
};
...
// Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
var VoiceFocusContext = React.createContext(null);
var VoiceFocusProvider = function (_a) {
    var spec = _a.spec, options = _a.options, children = _a.children;
    var _b = React.useState(undefined), isVoiceFocusSupported = _b[0], setIsVoiceFocusSupported = _b[1];
    var _c = React.useState(null), voiceFocusDevice = _c[0], setVoiceFocusDevice = _c[1];
    var _d = React.useState(null), voiceFocusTransformer = _d[0], setVoiceFocusTransformer = _d[1];
    ...
    function createVoiceFocusDeviceTransformer(spec, options, canceled) {
        return __awaiter(this, void 0, void 0, function () {
            var fetch;
            return __generator(this, function (_a) {
                fetch = amazonChimeSdkJs.VoiceFocusDeviceTransformer.create(spec, options);
                fetch
...
var useVoiceFocus = function () {
    var context = React.useContext(VoiceFocusContext);
    if (!context) {
...
var AudioInputVFControl = function (_a) {
    ...
    var _g = React.useState(false), isVoiceFocusChecked = _g[0], setIsVoiceFocusChecked = _g[1];
    ...
    var _h = React.useState(false), isVoiceFocusEnabled = _h[0], setIsVoiceFocusEnabled = _h[1];
    var _j = React.useState(null), dropdownWithVFOptions = _j[0], setDropdownWithVFOptions = _j[1];
    var _k = useToggleLocalMute(), muted = _k.muted, toggleMute = _k.toggleMute;
    var _l = React.useState(meetingManager.selectedAudioInputDevice), device = _l[0], setDevice = _l[1];
    ...
    React.useEffect(function () {
        ...
        if (device instanceof amazonChimeSdkJs.VoiceFocusTransformDevice) {
    ...
    React.useEffect(function () {
        var dropdownOptions = audioInputDevices.map(function (device) { return (React__default['default'].createElement(PopOverItem, { key: device.deviceId, children: React__default['default'].createElement("span", null, device.label), checked: isOptionActive(selectedDevice, device.deviceId), onClick: function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        if (isVoiceFocusSupported) {
            var vfOption = (React__default['default'].createElement(PopOverItem, { key: "voicefocus", children: React__default['default'].createElement(React__default['default'].Fragment, null,
    ...
    return (React__default['default'].createElement(ControlBarButton, { icon: React__default['default'].createElement(Microphone, { muted: muted, mutedTitle: mutedIconTitle, unmutedTitle: unmutedIconTitle }), onClick: toggleMute, label: muted ? unmuteLabel : muteLabel, children: dropdownWithVFOptions }));
};
...
var VideoInputBackgroundBlurControl = function (_a) {
    ...
    var _h = React.useState(null), dropdownWithVideoTransformOptions = _h[0], setDropdownWithVideoTransformOptions = _h[1];
    var _j = React.useState(meetingManager.selectedVideoInputTransformDevice), activeVideoDevice = _j[0], setDevice = _j[1];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        setIsLoading(true);
                        if (!!amazonChimeSdkJs.isVideoTransformDevice(current)) return [3 /*break*/, 2];
    ...
    React.useEffect(function () {
        var deviceOptions = videoDevices.map(function (option) { return (React__default['default'].createElement(PopOverItem, { key: option.deviceId, children: React__default['default'].createElement("span", null, option.label), checked: isOptionActive(selectedDevice, option.deviceId), onClick: function () { return __awaiter(void 0, void 0, void 0, function () {
                var receivedDevice, transformedDevice;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            if (!(amazonChimeSdkJs.isVideoTransformDevice(activeVideoDevice) && !isLoading)) return [3 /*break*/, 4];
                            setIsLoading(true);
        ...
        if (isBackgroundBlurSupported) {
            var videoTransformOptions = (React__default['default'].createElement(PopOverItem, { key: "videoinput", children: React__default['default'].createElement(React__default['default'].Fragment, null,
                    isLoading && React__default['default'].createElement(Spinner, { width: "1.5rem", height: "1.5rem" }),
                    backgroundBlurLabel), checked: amazonChimeSdkJs.isVideoTransformDevice(activeVideoDevice), disabled: isLoading, onClick: toggleBackgroundBlur }));
    ...
    return (React__default['default'].createElement(ControlBarButton, { icon: React__default['default'].createElement(Camera, { disabled: !isVideoEnabled }), onClick: toggleVideo, label: label, children: dropdownWithVideoTransformOptions }));
};
...
var PreviewVideo = function (props) {
    ...
    // TODO: Move this to the Video Input Provider and expose only one selected Video Input device state
    var _a = React.useState(meetingManager.selectedVideoInputTransformDevice), device = _a[0], setDevice = _a[1];
    // TODO: Move this to the Video Input Provider and expose only one selected Video Input device state
    React.useEffect(function () {
        meetingManager.subscribeToSelectedVideoInputTransformDevice(setDevice);
        return function () {
