import { AudioTransformDevice, Device, Logger, LogLevel, VideoDownlinkBandwidthPolicy } from 'amazon-chime-sdk-js';
...
interface Props {
     ...
     */
    onDeviceReplacement?: (nextDevice: string, currentDevice: Device | AudioTransformDevice) => Promise<Device | AudioTransformDevice>;
